...
namespace CompleteProject
{
	public class PlayerAttack : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (gameObject.name == "GunBarrelEnd_Air")
            {
                isIce = false;
                isFire = false;
                isAir = true;
        ...
        void IceShoot()
        {
            ...
            if (Physics.Raycast(shootRay, out shootHit, range, attackableMask))
            {
				...
				HealthPack healthPack = shootHit.collider.GetComponent<HealthPack> ();
				Treasure loot = shootHit.collider.GetComponent<Treasure> ();
        ...
        void Fireball()
        {
			...
			_fireball.GetComponent<Rigidbody>().velocity = _fireball.transform.forward * throwForce;
		}
